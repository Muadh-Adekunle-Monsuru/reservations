			...
			<form onSubmit={addReservation}>
				<div className='text-white'>
					...
					<div className='w-full flex justify-center items-center p-10 shadow-xl'>
						<button
							className='select-none rounded-lg bg-gradient-to-tr from-gray-900 to-gray-800 py-5 px-10 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-gray-900/10 transition-all hover:shadow-lg hover:shadow-gray-900/20 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none'
							type='submit'
						>
							Make Reservation
						</button>

				...
				<section className='w-full py-20 md:py-32'>
					<div className='mx-auto px-4 md:px-6'>
						...
						<p className='text-gray-600 dark:text-gray-400 text-lg mb-12'>
							...
							and her lover, despite his claims of innocence. Over the next two
							decades, he befriends a fellow prisoner, Red, and finds ways to
							make life more bearable for his fellow inmates.
						</p>
